...
const InfoBlock = () => {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="flex flex-wrap items-center justify-center lg:justify-between gap-10 py-13">
        {info.map((details) => (
          <div key={details.id} className="w-full max-w-[320px]">
            ...
            <p className="mt-5 text-center text-[16px] font-normal leading-6 text-black">
              {details.description}
            </p>
          </div>
        ))}
